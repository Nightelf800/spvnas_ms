...
class SPConvolutionForward(Cell):
    def __init__(self, ):
        ...
        spconvolution_transpose_back = ops.Custom(
            "./mindsparse/nn/cuda/convolution/convolution_cuda.so:convolution_transpose_backward_ms",
        ...
        spconvolution_no_transpose_back = ops.Custom(
            "./mindsparse/nn/cuda/convolution/convolution_cuda.so:convolution_no_transpose_backward_ms",
            out_shape=infer_func_back,
            out_dtype=infer_func_back,
            func_type="aot",
            reg_info=conv_backward_cuda_info)
        ...
        self.spconvolution_transpose = ops.Custom(
            "./mindsparse/nn/cuda/convolution/convolution_cuda.so:convolution_transpose_forward_ms",
        ...
        self.spconvolution_no_transpose = ops.Custom(
            "./mindsparse/nn/cuda/convolution/convolution_cuda.so:convolution_no_transpose_forward_ms",
            out_shape=infer_func,
            out_dtype=infer_func,
            func_type="aot",
            bprop=bprop,
...
if __name__ == '__main__':
    os.environ["MS_CUSTOM_AOT_WHITE_LIST"] = "./mindsparse/nn/cuda"
