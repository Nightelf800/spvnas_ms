    ...
    def __init__(self,):
        ...
        def bprop(inputs, idx, counts, out, grad_output):
            ...
            if get_context("device_target") == 'GPU':
                ...
                sp_voxelize_backward = ops.Custom("mindsparse/nn/cuda/voxelize/voxelize_cuda.so:voxelize_backward_ms",
                                                  infer_func_back,
                                                  infer_func_back,
                                                  func_type="aot",
        ...
        self.spvoxelize = ops.Custom("mindsparse/nn/cuda/voxelize/voxelize_cuda.so:voxelize_forward_ms",
                                     infer_func,
                                     infer_func,
                                     func_type="aot",
                                     bprop=bprop,
