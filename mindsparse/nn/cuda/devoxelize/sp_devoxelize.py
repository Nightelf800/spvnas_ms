...
def bprop():
    ...
    sp_devoxelize_backward = ops.Custom(
        "./mindsparse/nn/cuda/devoxelize/devoxelize_cuda.so:devoxelize_backward_ms",
...
class SPDevoxelizeForward(Cell):
    def __init__(self, ):
        ...
        self.spdevoxelize = ops.Custom("./mindsparse/nn/cuda/devoxelize/devoxelize_cuda.so:devoxelize_forward_ms",
...
class SPDevoxelizeBackward(Cell):
    def __init__(self, ):
        ...
        self.spdevoxelize = ops.Custom("./mindsparse/nn/cuda/devoxelize/devoxelize_cuda.so:devoxelize_backward_ms",
                                       out_shape=infer_func,
                                       out_dtype=infer_func,
                                       func_type="aot")
